...
public class EmployeeController {
    ...
    public String saveEmployee(@RequestBody EmployeeDTO1 employeeDTO)
    {
        String id = employeeService.addEmployee(employeeDTO);
        return id;
    }
    @PostMapping(path = "/login")
    public ResponseEntity<?> loginEmployee(@RequestBody com.example.RegisterLogin.Service.LoginDTO loginDTO)
    {
